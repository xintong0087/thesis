    ...
    \begin{figure}[H]
        \makebox[\textwidth][c]{
            \subfigure{
                ...
                \node at (2,-3.1) {1 Outer Path in standard SPNS};
                \end{tikzpicture}}
            \subfigure{
                ...
                \node at (4.5,-1.3) {1 Outer Path in standard MPNS};
                \end{tikzpicture}
                }}
	\end{figure}

    Metamodeling: think of the inner simulation as a black-box function.
