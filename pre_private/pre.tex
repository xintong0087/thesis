...
\begin{frame}{Results: Accuracy Comparison}
    ...
    \note{Note that for layer-freezing, freezing the LSTM layers lead to better performance. }
...
\begin{frame}{Learning Curves: Effect of Freezing Layers}
    ...
    \note{We suspect that the LSTM layers capture the time series component of the data, and the fully connected layers use the output of the LSTM layers to learn the VA contract losses.}
...
\begin{frame}{Metamodel Performance}
    ...
    \note{These figures examine the performance of transfer learning to GMWB contracts. \\}
    \note{The source task is a GMMB, and the target task is a GMWB with dynamic lapse. \\}
...
\begin{frame}{Conclusions}
    ...
    \note{The approach enables pooling on a higher level, that is, pooling across different contracts. \\}
    ...
    \note{In the future, we can also consider multi-task learning to handle multiple contracts simultaneously. }
