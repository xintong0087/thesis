...
More specifically, at any time $t$, the neural network can directly learn the policy from simulated trajectories upto maturity.
The knowing of the model prior to maturity and the ability to move back in time makes an RL algorithm model-based~\citep{moerland2023model}.
