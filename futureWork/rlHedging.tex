...
\end{equation}
The reward function of the GMWB directly links to the time-$t$ loss of a GMWB contract as in Equation~\eqref{eq3:lossGMWB}.
...
In a recurrent PPO with LSTM, the policy and reward function remain the same but with the new state representation in Equation~\eqref{eq3:stateRNN}.
