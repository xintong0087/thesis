...
\newabbreviation{mtl}{MTL}{Multi-Task Learning}
...
\newabbreviation{gmm}{GMMB}{Guaranteed Minimum Maturity Benefit}
\newabbreviation{gmb}{GMWB}{Guaranteed Minimum Withdrawal Benefit}
\newabbreviation{reg}{REG}{Regression}
\newabbreviation{ks}{KS}{Kernel Smoothing}
\newabbreviation{lr}{LR}{Likelihood Ratio}
