...
\textcolor{red}{Need to collect the result for RNN and LSTM}
...
A metamodel that uses less safety margin to rank can save simulation budget in stage 2.
...
\textcolor{red}{Need to separate the bad RNN from the good RNN for Figure~\ref{fig2:tailMatches}.}
...
\textcolor{red}{Need to separate the bad RNN from the good RNN for Figure~\ref{fig2:CVaR95}.}
...
\textcolor{red}{The $N=1$ plot is not valid}
