...
\begin{algorithm} 
\caption{Standard Nested Simulation Procedure for Estimating CVaR for \gls{gmwb} Hedging Losses}
...
\begin{table}[ht]
    ...
    \begin{tabular}{lc}
        ...
        \bottomrule
    \end{tabular}
    \caption{Real-world parameters for the \gls{rsgbm} model (monthly rates)}
