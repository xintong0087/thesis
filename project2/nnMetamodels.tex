...
Let $L_1,L_2,\ldots,L_M$ be $M$ independent and identically distributed (i.i.d.) simulated losses of $L$ and let $L_{(1)}\leq L_{(2)}\leq \ldots\leq L_{(M)}$ be the ordered losses.
...
\footnotetext{This row summarizes the error metrics of the well-trained RNN, where the ones suffer from a vanishing gradient issue are removed from the averages.}
