...
This paper presents a survey study of some popular nested simulation procedures with both asymptotic convergence analysis and numerical experiments.
...
In this chapter, we discuss the asymptotic convergence of the nested simulation procedures in terms of the MSE of the estimator, and we provide a comprehensive comparison of their convergence rates and critical assumptions.
...
In terms of finite-sample performance, this chapter shows that different studies propose different examples in their numerical experiments, which introduces unfair advantages for certain simulation procedures over others. 
...
AE is a less stringent error metric than the MSE. 
